...
template<int32_t orderX, int32_t iterX, int32_t orderA, int32_t beta>
...
inline void crt_acc_dispatcher(cudaStream_t stream, int32_t beta, int64_t N, const int32_t* X, int64_t ldx, uint64_t* A) {
...
inline void crt_acc_dispatcher(cudaStream_t stream, int32_t beta, int64_t N, int32_t orderX, int32_t iter, const int32_t* X, int64_t ldx, uint64_t* A) {
  if (iter == 0) switch (orderX) {
    case 2: crt_acc_dispatcher<2, 0, orderA>(stream, beta, N, X, ldx, A); return;
    case 3: crt_acc_dispatcher<3, 0, orderA>(stream, beta, N, X, ldx, A); return;
    case 4: crt_acc_dispatcher<4, 0, orderA>(stream, beta, N, X, ldx, A); return;
    case 5: crt_acc_dispatcher<5, 0, orderA>(stream, beta, N, X, ldx, A); return;
    case 6: crt_acc_dispatcher<6, 0, orderA>(stream, beta, N, X, ldx, A); return;
    case 7: crt_acc_dispatcher<7, 0, orderA>(stream, beta, N, X, ldx, A); return;
    case 8: crt_acc_dispatcher<8, 0, orderA>(stream, beta, N, X, ldx, A); return;
    case 9: crt_acc_dispatcher<9, 0, orderA>(stream, beta, N, X, ldx, A); return;
    case 10: crt_acc_dispatcher<10, 0, orderA>(stream, beta, N, X, ldx, A); return;
    case 11: crt_acc_dispatcher<11, 0, orderA>(stream, beta, N, X, ldx, A); return;
    case 12: crt_acc_dispatcher<12, 0, orderA>(stream, beta, N, X, ldx, A); return;
    case 13: crt_acc_dispatcher<13, 0, orderA>(stream, beta, N, X, ldx, A); return;
    case 14: crt_acc_dispatcher<14, 0, orderA>(stream, beta, N, X, ldx, A); return;
    case 15: crt_acc_dispatcher<15, 0, orderA>(stream, beta, N, X, ldx, A); return;
    case 16: crt_acc_dispatcher<16, 0, orderA>(stream, beta, N, X, ldx, A); return;
    case 17: crt_acc_dispatcher<17, 0, orderA>(stream, beta, N, X, ldx, A); return;
    case 18: crt_acc_dispatcher<18, 0, orderA>(stream, beta, N, X, ldx, A); return;
    case 19: crt_acc_dispatcher<19, 0, orderA>(stream, beta, N, X, ldx, A); return;
    case 20: crt_acc_dispatcher<20, 0, orderA>(stream, beta, N, X, ldx, A); return;
    case 21: crt_acc_dispatcher<21, 0, orderA>(stream, beta, N, X, ldx, A); return;
    case 22: crt_acc_dispatcher<22, 0, orderA>(stream, beta, N, X, ldx, A); return;
    case 23: crt_acc_dispatcher<23, 0, orderA>(stream, beta, N, X, ldx, A); return;
    default: return;
  }
  else if (iter == 1) switch (orderX) {
    case 9: crt_acc_dispatcher<9, 1, orderA>(stream, beta, N, X, ldx, A); return;
    case 10: crt_acc_dispatcher<10, 1, orderA>(stream, beta, N, X, ldx, A); return;
    case 11: crt_acc_dispatcher<11, 1, orderA>(stream, beta, N, X, ldx, A); return;
    case 12: crt_acc_dispatcher<12, 1, orderA>(stream, beta, N, X, ldx, A); return;
    case 13: crt_acc_dispatcher<13, 1, orderA>(stream, beta, N, X, ldx, A); return;
    case 14: crt_acc_dispatcher<14, 1, orderA>(stream, beta, N, X, ldx, A); return;
    case 15: crt_acc_dispatcher<15, 1, orderA>(stream, beta, N, X, ldx, A); return;
    case 16: crt_acc_dispatcher<16, 1, orderA>(stream, beta, N, X, ldx, A); return;
    case 17: crt_acc_dispatcher<17, 1, orderA>(stream, beta, N, X, ldx, A); return;
    case 18: crt_acc_dispatcher<18, 1, orderA>(stream, beta, N, X, ldx, A); return;
    case 19: crt_acc_dispatcher<19, 1, orderA>(stream, beta, N, X, ldx, A); return;
    case 20: crt_acc_dispatcher<20, 1, orderA>(stream, beta, N, X, ldx, A); return;
    case 21: crt_acc_dispatcher<21, 1, orderA>(stream, beta, N, X, ldx, A); return;
    case 22: crt_acc_dispatcher<22, 1, orderA>(stream, beta, N, X, ldx, A); return;
    case 23: crt_acc_dispatcher<23, 1, orderA>(stream, beta, N, X, ldx, A); return;
    default: return;
  }
  else if (iter == 2) switch (orderX) {
    case 17: crt_acc_dispatcher<17, 2, orderA>(stream, beta, N, X, ldx, A); return;
    case 18: crt_acc_dispatcher<18, 2, orderA>(stream, beta, N, X, ldx, A); return;
    case 19: crt_acc_dispatcher<19, 2, orderA>(stream, beta, N, X, ldx, A); return;
    case 20: crt_acc_dispatcher<20, 2, orderA>(stream, beta, N, X, ldx, A); return;
    case 21: crt_acc_dispatcher<21, 2, orderA>(stream, beta, N, X, ldx, A); return;
    case 22: crt_acc_dispatcher<22, 2, orderA>(stream, beta, N, X, ldx, A); return;
    case 23: crt_acc_dispatcher<23, 2, orderA>(stream, beta, N, X, ldx, A); return;
    default: return;
  }
}

void internal::int8::accumulate_remainder_i32tensor(cudaStream_t stream, int32_t beta, int32_t N, int32_t orderX, int32_t iter, const int32_t* X, int32_t ldx, int32_t orderA, uint64_t* A) {
  switch (orderA) {
    case 1: crt_acc_dispatcher<1>(stream, beta, int64_t(N), orderX, iter, X, int64_t(ldx), A); return;
    case 2: crt_acc_dispatcher<2>(stream, beta, int64_t(N), orderX, iter, X, int64_t(ldx), A); return;
    case 3: crt_acc_dispatcher<3>(stream, beta, int64_t(N), orderX, iter, X, int64_t(ldx), A); return;
    default: return;
  }
}
