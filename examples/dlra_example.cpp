...
int32_t main(int32_t argc, char* argv[]) {
  ...
  device::interp_decomp_f64(stream, handle, epi, N, M, N, d_A, M, ipiv.data(), d_X, N);
  ...
  double rel_err = 0.;
  device::check_interp_decomp_f64(stream, handle, rank, M, N, d_A, M, ipiv.data(), d_X, N, &rel_err);
