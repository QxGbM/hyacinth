...
int32_t main(int32_t argc, char* argv[]) {
  ...
  double rel_err = device::check_interp_decomp_f64(handle, rank, M, N, d_A, M, ipiv.data(), d_X, N);
  ...
  std::cout << "D-LRA," << M << "," << N << "," << epi << "," << omega << "," << sep << "," << rel_err << "," << rank << "," << milliseconds << "," << gflops << std::endl;
