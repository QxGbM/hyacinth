...
namespace internal::Cholesky {
  ...
  void gemv_scal_f64(cudaStream_t stream, const double* scale, int32_t M, int32_t N, const double* A, int32_t lda, double* B, double* D);

  void gemv_scal_f32(cudaStream_t stream, const float* scale, int32_t M, int32_t N, const float* A, int32_t lda, float* B, float* D);

  void gemv_scal_f128_dd(cudaStream_t stream, const double2* scale, int32_t M, int32_t N, const double2* A, int32_t lda, double2* B, double2* D);

  void gemv_scal_f128_qf(cudaStream_t stream, const float4* scale, int32_t M, int32_t N, const float4* A, int32_t lda, float4* B, float4* D);

  void gemv_scal_cf64(cudaStream_t stream, const double* scale, int32_t M, int32_t N, const std::complex<double>* A, int32_t lda, std::complex<double>* B, double* D);

  void gemv_scal_cf32(cudaStream_t stream, const float* scale, int32_t M, int32_t N, const std::complex<float>* A, int32_t lda, std::complex<float>* B, float* D);

  void gemv_scal_cf128_dd(cudaStream_t stream, const double2* scale, int32_t M, int32_t N, const complex_double2* A, int32_t lda, complex_double2* B, double2* D);

  void gemv_scal_cf128_qf(cudaStream_t stream, const float4* scale, int32_t M, int32_t N, const complex_float4* A, int32_t lda, complex_float4* B, float4* D);

  void reduce_scal_f64(cudaStream_t stream, const double* scale, int32_t M, int32_t N, double* A, int32_t lda, double* D);

  void reduce_scal_f32(cudaStream_t stream, const float* scale, int32_t M, int32_t N, float* A, int32_t lda, float* D);

  void reduce_scal_f128_dd(cudaStream_t stream, const double2* scale, int32_t M, int32_t N, double2* A, int32_t lda, double2* D);

  void reduce_scal_f128_qf(cudaStream_t stream, const float4* scale, int32_t M, int32_t N, float4* A, int32_t lda, float4* D);
