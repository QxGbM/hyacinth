...
namespace internal::Cholesky {
  ...
  void swap_cols_f64(cudaStream_t stream, int32_t j, int32_t M, int32_t N, double* A, int32_t lda);

  void swap_cols_f32(cudaStream_t stream, int32_t j, int32_t M, int32_t N, float* A, int32_t lda);

  void swap_cols_f128_dd(cudaStream_t stream, int32_t j, int32_t M, int32_t N, double2* A, int32_t lda);

  void swap_cols_f128_qf(cudaStream_t stream, int32_t j, int32_t M, int32_t N, float4* A, int32_t lda);

  void swap_cols_cf64(cudaStream_t stream, int32_t j, int32_t M, int32_t N, std::complex<double>* A, int32_t lda);

  void swap_cols_cf32(cudaStream_t stream, int32_t j, int32_t M, int32_t N, std::complex<float>* A, int32_t lda);

  void swap_cols_cf128_dd(cudaStream_t stream, int32_t j, int32_t M, int32_t N, complex_double2* A, int32_t lda);

  void swap_cols_cf128_qf(cudaStream_t stream, int32_t j, int32_t M, int32_t N, complex_float4* A, int32_t lda);
