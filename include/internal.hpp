...
namespace internal::int8 {
  ...
  void vexp_f64(cudaStream_t stream, int32_t q_range, int32_t M, int32_t N, const double* A, int32_t lda, int32_t* vec_expon);

  void vexp_f32(cudaStream_t stream, int32_t q_range, int32_t M, int32_t N, const float* A, int32_t lda, int32_t* vec_expon);
