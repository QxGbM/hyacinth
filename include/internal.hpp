...
namespace internal::Cholesky {
  ...
  int32_t potrfp_f64(cudaStream_t stream, cublasHandle_t handle, double epi, int32_t rank, int32_t N, double* A, int32_t lda, int32_t* jpiv, void* pinned_work);

  int32_t potrfp_f32(cudaStream_t stream, cublasHandle_t handle, double epi, int32_t rank, int32_t N, float* A, int32_t lda, int32_t* jpiv, void* pinned_work);

  int32_t potrfp_f128_dd(cudaStream_t stream, cublasHandle_t handle, double epi, int32_t rank, int32_t N, double2* A, int32_t lda, int32_t* jpiv, void* pinned_work);

  int32_t potrfp_f128_qf(cudaStream_t stream, cublasHandle_t handle, double epi, int32_t rank, int32_t N, float4* A, int32_t lda, int32_t* jpiv, void* pinned_work);

  int32_t potrfp_cf64(cudaStream_t stream, cublasHandle_t handle, double epi, int32_t rank, int32_t N, std::complex<double>* A, int32_t lda, int32_t* jpiv, void* pinned_work);

  int32_t potrfp_cf32(cudaStream_t stream, cublasHandle_t handle, double epi, int32_t rank, int32_t N, std::complex<float>* A, int32_t lda, int32_t* jpiv, void* pinned_work);

  int32_t potrfp_cf128_dd(cudaStream_t stream, cublasHandle_t handle, double epi, int32_t rank, int32_t N, complex_double2* A, int32_t lda, int32_t* jpiv, void* pinned_work);

  int32_t potrfp_cf128_qf(cudaStream_t stream, cublasHandle_t handle, double epi, int32_t rank, int32_t N, complex_float4* A, int32_t lda, int32_t* jpiv, void* pinned_work);
