...
void device::cublas_preload_real(cublasHandle_t handle) {
  ...
  internal::Cholesky::gemv_scal_f128_dd(stream, scale, 1, 2, 2, &((double2*)A)[8], 4, (double2*)A, (double2*)scale);
  internal::Cholesky::gemv_scal_f128_dd(stream, scale, 0, 2, 0, &((double2*)A)[8], 4, (double2*)A, (double2*)scale);
