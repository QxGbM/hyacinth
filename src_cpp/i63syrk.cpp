...
void internal::int8::i63ATA_f64_limbs(cudaStream_t stream, cublasHandle_t handle, int32_t M, int32_t N, const double* A, int32_t lda, int32_t umax, const uint64_t* vec_expon, int32_t algnM, int32_t orderA, int32_t orderC, uint64_t* C, int32_t ldc, int8_t* workspace) {
...
void internal::int8::i63ATA_f32_limbs(cudaStream_t stream, cublasHandle_t handle, int32_t M, int32_t N, const float* A, int32_t lda, int32_t umax, const uint64_t* vec_expon, int32_t algnM, int32_t orderA, int32_t orderC, uint64_t* C, int32_t ldc, int8_t* workspace) {
  int64_t strideA = int64_t(algnM) * int64_t(N) * int64_t(orderA);
  int32_t* scratch = (int32_t*)&workspace[strideA];
...
void internal::int8::i63AHA_cf64_limbs(cudaStream_t stream, cublasHandle_t handle, int32_t M, int32_t N, const std::complex<double>* A, int32_t lda, int32_t umax, const uint64_t* vec_expon, int32_t algnM, int32_t orderA, int32_t orderC, uint64_t* C, int32_t ldc, int8_t* workspace) {
...
void internal::int8::i63AHA_cf32_limbs(cudaStream_t stream, cublasHandle_t handle, int32_t M, int32_t N, const std::complex<float>* A, int32_t lda, int32_t umax, const uint64_t* vec_expon, int32_t algnM, int32_t orderA, int32_t orderC, uint64_t* C, int32_t ldc, int8_t* workspace) {
  int64_t strideA = int64_t(algnM) * int64_t(N) * int64_t(orderA), strideC = int64_t(ldc) * int64_t(N) * int64_t(orderC);
  int32_t* scratch = (int32_t*)&workspace[strideA << 1];
...
void internal::int8::i63ATA_f64_crt(cudaStream_t stream, cublasHandle_t handle, int32_t M, int32_t N, const double* A, int32_t lda, int32_t umax, const uint64_t* vec_expon, int32_t algnM, int32_t n_moduli, uint64_t* C, int32_t ldc, int8_t* workspace) {
...
void internal::int8::i63ATA_f32_crt(cudaStream_t stream, cublasHandle_t handle, int32_t M, int32_t N, const float* A, int32_t lda, int32_t umax, const uint64_t* vec_expon, int32_t algnM, int32_t n_moduli, uint64_t* C, int32_t ldc, int8_t* workspace) {
  int64_t strideA = int64_t(algnM) * int64_t(N);
  int32_t* scratch = (int32_t*)&workspace[strideA << 3];
...
void internal::int8::i63AHA_cf64_crt(cudaStream_t stream, cublasHandle_t handle, int32_t M, int32_t N, const std::complex<double>* A, int32_t lda, int32_t umax, const uint64_t* vec_expon, int32_t algnM, int32_t n_moduli, int32_t orderC, uint64_t* C, int32_t ldc, int8_t* workspace) {
...
void internal::int8::i63AHA_cf32_crt(cudaStream_t stream, cublasHandle_t handle, int32_t M, int32_t N, const std::complex<float>* A, int32_t lda, int32_t umax, const uint64_t* vec_expon, int32_t algnM, int32_t n_moduli, int32_t orderC, uint64_t* C, int32_t ldc, int8_t* workspace) {
  int64_t strideA = int64_t(algnM) * int64_t(N), strideC = int64_t(orderC) * int64_t(ldc) * int64_t(N);
  int32_t* scratch = (int32_t*)&workspace[strideA << 4];
