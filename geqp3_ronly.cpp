...
int32_t device::QR::dgeqp3_ronly(cudaStream_t stream, cublasHandle_t handle, geqp3_params params, double* A, int32_t lda, int32_t* ipiv, void* workspace) {
  ...
  int32_t order = params.order;
  int32_t strideA = algnM * algnN;
  int32_t strideC = algnN * algnN;

  int8_t* iA = (int8_t*)(workspace);
  int32_t* AHA = (int32_t*)(&iA[params.n_i8]);
  int32_t* vexp = &AHA[2 * algnN * algnN * order];
  ...
  internal::int8::vexp_f64(stream, order, M, N, A, lda, vexp);
  internal::int8::encode_f64(stream, order, M, N, A, lda, vexp, iA, algnM, strideA);
  internal::int8::r8i_TN_gemm_strided_AC(stream, handle, 0, order, algnN, algnN, algnM, iA, strideA, iA, AHA, strideC);

  if (elem_bytes == 4) {
    float* mat_f32 = (float*)mat;
    internal::int8::decode_f32_strided_i32(stream, 2 * order, N, vexp, AHA, algnN, mat_f32, algnN);
    ...
    internal::int8::decode_f64_strided_i32(stream, 2 * order, N, vexp, AHA, algnN, mat_f64, algnN);
    ...
    internal::int8::decode_dd_strided_i32(stream, 2 * order, N, vexp, AHA, algnN, mat_dd, algnN);
    ...
    internal::int8::decode_qf_strided_i32(stream, 2 * order, N, vexp, AHA, algnN, mat_qf, algnN);
...
int32_t device::QR::sgeqp3_ronly(cudaStream_t stream, cublasHandle_t handle, geqp3_params params, float* A, int32_t lda, int32_t* ipiv, void* workspace) {
  ...
  cudaMemsetAsync(workspace, 0, int_bytes);
  void* mat = &iA[int_bytes];
  internal::int8::vexp_f32(stream, order, M, N, A, lda, vexp);
  internal::int8::encode_f32(stream, order, M, N, A, lda, vexp, iA, algnM, strideA);
  internal::int8::r8i_TN_gemm_strided_AC(stream, handle, 0, order, algnN, algnN, algnM, iA, strideA, iA, AHA, strideC);
...
int32_t device::QR::zgeqp3_ronly(cudaStream_t stream, cublasHandle_t handle, geqp3_params params, std::complex<double>* A, int32_t lda, int32_t* ipiv, void* workspace) {
  ...
  int8_t* iA = (int8_t*)(workspace);
  int32_t* AHA = (int32_t*)(&iA[params.n_i8]);
  int32_t* vexp = &AHA[4 * algnN * algnN * order];
  int32_t elem_bytes = params.elem_bytes;
  int32_t ret = 0;
  ...
  cudaMemsetAsync(workspace, 0, int_bytes);
  void* mat = &iA[int_bytes];
  internal::int8::vexp_cf64(stream, order, M, N, A, lda, vexp);
  internal::int8::encode_cf64(stream, order, M, N, A, lda, vexp, iA, algnM, strideA);
  internal::int8::c8i_HN_gemm_strided_AC(stream, handle, 0, order, algnN, algnN, algnM, iA, strideA, iA, AHA, strideC);

  if (elem_bytes == 8) {
    std::complex<float>* mat_f32 = (std::complex<float>*)mat;
    internal::int8::decode_cf32_strided_i32(stream, 2 * order, N, vexp, AHA, algnN, mat_f32, algnN);
    ...
    internal::int8::decode_cf64_strided_i32(stream, 2 * order, N, vexp, AHA, algnN, mat_f64, algnN);
    ...
    internal::int8::decode_complex_dd_strided_i32(stream, 2 * order, N, vexp, AHA, algnN, mat_dd, algnN);
    ...
    internal::int8::decode_complex_qf_strided_i32(stream, 2 * order, N, vexp, AHA, algnN, mat_qf, algnN);
...
int32_t device::QR::cgeqp3_ronly(cudaStream_t stream, cublasHandle_t handle, geqp3_params params, std::complex<float>* A, int32_t lda, int32_t* ipiv, void* workspace) {
  ...
  cudaMemsetAsync(workspace, 0, int_bytes);
  void* mat = &iA[int_bytes];
  internal::int8::vexp_cf32(stream, order, M, N, A, lda, vexp);
  internal::int8::encode_cf32(stream, order, M, N, A, lda, vexp, iA, algnM, strideA);
  internal::int8::c8i_HN_gemm_strided_AC(stream, handle, 0, order, algnN, algnN, algnM, iA, strideA, iA, AHA, strideC);
