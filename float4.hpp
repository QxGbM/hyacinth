...
struct complex_float4 {
  float4 real;
  float4 imag;
  complex_float4(float4 real, float4 imag) : real(real), imag(imag) {}
};
...
namespace host::f4 {
  ...
  inline complex_float4 conj(complex_float4 a) {
    return complex_float4(a.real, negate(a.imag));
  }

  inline complex_float4 add(complex_float4 a, complex_float4 b) {
    return complex_float4(add(a.real, b.real), add(a.imag, b.imag));
  }
